#' Returns the URI constructed from the parameter settings for the Multi Channel Funnel Reporting API. This also
...
ToUriMCF <- function(query.builder,token) {
  ...
  uri <- "https://www.googleapis.com/analytics/v3/data/mcf?" #Multi Channel Funnel API
